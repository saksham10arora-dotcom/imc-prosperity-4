# 03 — The Scrooge McDuck Bot: Hidden Alpha in Empty Books
...
| Metric | Without Scrooge | With Scrooge |
|---|---|---|
| Live PnL | 10,700 | **12,200** |
| Improvement | — | **+1,500 (+14%)** |

The Scrooge exploit contributed ~1.5K of the final 12.2K live score. Implementation required reserving 15 units of position capacity (soft limit 65 instead of 80) to leave room for Scrooge fills.

## Lesson Learned

**The biggest PnL gain in Round 1 came from a competitor tip, not from data analysis.** All our research (V13–V16, asymmetry signal, bot sniping) produced zero incremental alpha. The Scrooge discovery — found by probing live, not by analyzing CSVs — was worth +1.5K.
